  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
        <?php echo $this->Html->link('Student_fess', array("controller" => 'StudentFees','action' => 'index'),array('class'=>"nav-link")); ?>

        </li> 
        <li class="nav-item">
        <?php echo $this->Html->link('log_out', array("controller" => 'Users','action' => 'login'),array('class'=>"nav-link")); ?>
